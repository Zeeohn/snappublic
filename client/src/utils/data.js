export const catalogs = [
  ...
  {
    name: 'museums',
    image: 'https://i.pinimg.com/originals/00/d3/70/00d370b2f62e3de578fcb0bfead9586c.jpg'
  },
  {
    name: 'photo',
...
export const pinDetailMorePinQuery = (pin) => {
  const query = `*[_type == "pin" && catalog == '${pin.catalog}' && _id != '${pin._id}' ]{
    image{
      asset->{
        url
      }
...
export const searchQuery = (searchTerm) => {
  const query = `*[_type == "pin" && title match '${searchTerm}*' || catalog match '${searchTerm}*' || about match '${searchTerm}*']{
        image{
          asset->{
            url
          }
